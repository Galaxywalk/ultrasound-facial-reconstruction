...
//#if defined(__MSP430_HAS_USCI_B0__) || defined(__MSP430_HAS_USCI_B1__) || defined(__MSP430_HAS_USCI__) || defined(__MSP430_HAS_EUSCI_B1__)
...
uint8_t spi_send_pga460_g2553(const uint8_t);
void spi_set_bitorder_pga460_g2553(const uint8_t);
void spi_set_datamode_pga460_g2553(const uint8_t);
void spi_set_divisor_pga460_g2553(const uint16_t clkdivider);
