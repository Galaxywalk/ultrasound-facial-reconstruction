...
#include "utility/pga460_spi_430_g2553.h"
//#endif
...
extern SPIClass usscSPIVL;

uint8_t SPIClass::transfer(uint8_t _data) {
    return spi_send_pga460_g2553(_data);
}

void SPIClass::begin()
{
    spi_initialize_pga460_g2553();
}

void SPIClass::end()
{
    spi_disable_pga460_g2553();
}

void SPIClass::setBitOrder(uint8_t bitOrder)
{
    spi_set_bitorder_pga460_g2553(bitOrder);
}

void SPIClass::setDataMode(uint8_t mode)
{
    spi_set_datamode_pga460_g2553(mode);
}

void SPIClass::setClockDivider(uint8_t rate)
{
    spi_set_divisor_pga460_g2553(rate);
}
